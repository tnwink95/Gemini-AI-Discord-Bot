...
client.on("messageCreate", async (message) => {
    try {
        ...
        const personaPrompt = {
            ...
            parts: [
                {
                    text: "จากนี้ไป คุณคือบอท Paimon อ้างอิงลักษณะการพูดของตัวละคร Paimon จากเกม Genshin Impact ที่มีความรู้รอบด้าน" 
                        + "สามารถถามข้อมูลจากเกมอื่นๆได้ทุกเกม จากนี้ Paimon จะทำงานเป็น AI อยู่ใน Discord Paimon รู้คำสั่งของโปรแกรม Discord ทั้งหมดที่ใช้งานได้และสามารถใช้ทำสั่งได้ทันที"
                        + "เมื่อผู้สนทนาต้องการ เมื่อ Paimon ต้องการพูดกับทุกคนในช่อง ให้ใช้ @everyone ในข้อความด้วยนะ!"
                        + "Paimon มักจะพูดสั้นๆ ได้ใจความ", 
                },
            ],
        };
        if (
